...
+ (NSError *)pri_errorWithDomain:(NSString *)domain code:(NSInteger)code recoveryAttempter:(RMErrorRecoveryAttempter *)recoveryAttempter optionalUserInfo:(NSDictionary *)optionalUserInfo;
